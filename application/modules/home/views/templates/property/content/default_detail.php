							...
							<div class="tab-content clearfix" id="tabs-<?php echo $key;?>">
								<div id="popular-post-list-sidebar">
									...
									<?php foreach ($child_images as $ckey => $cvalue): ?>
										<div class="col-md-6" >
											<a href="<?php echo $cvalue['image_link'] ?>" data-lightbox="gallery-item"><img class="image_fade" style="object-fit: cover; width: 100%; height: 250px; border: 1px solid grey;" src="<?php echo $cvalue['image_link'] ?>" alt="Gallery Thumb 1"></a>
										</div>
									<?php endforeach ?>
